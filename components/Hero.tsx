 ...
 return <section id="hero" aria-labelledby="hero-title" className="hero">
  <div className="shell hero-grid">
   <div className="hero-copy">
    ...
    <p className="lede hero-subhead">Klaviyo flows, campaigns designed in your brand, and the deliverability work underneath so it actually reaches the inbox.</p>
  ...
  <div className="border-y border-white/15"><Marquee/></div>
 </section>;
}
